# Django settings for roxy project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': join_with_project_path('db','roxy.db'),
        'USER': '',                      
        'PASSWORD': '',                  
        'HOST': '',                     
        'PORT': '',                    
...
SECRET_KEY = 'cnpd3=bz_&2b$o_yfsvnky!8gbu^r#vo=#&todt_-v-)^_1=v@'
